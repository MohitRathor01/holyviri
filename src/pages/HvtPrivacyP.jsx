        ...
        <div className="row">
          <div className="col-12 text-center mb-4">
            <h2 className="fw-bold fs-1">
              Privacy
              <span className="text main-hover"> Policy </span>
            </h2>
          </div>
        </div>
        <div className="row">
          <div className="col-12 col-md-8 offset-md-2">
            <p className="text-center">
              [23:33, 6/19/2024] Mohit Zwolf: et only [23:33, 6/19/2024]
              Krishna: Alright [09:12, 6/20/2024] Praveen Sir ZWolf Startup:
              Privacy Policy for Holi Vrindavan Tour- At Holi Vrindavan Tour,
              accessible at holivrindavantour.com, one of our main priorities is
              the privacy of our visitors. This Privacy Policy document contains
              types of information that is collected and recorded by Holi
              Vrindavan Tour and how we use it. If you have additional questions
              or require more information about our Privacy Policy, do not
              hesitate to contact us through email at
              holivrindavantour@gmail.com This privacy policy applies only to
              ...
              Holi Vrindavan Tour. This policy is not applicable to any
              ...
              Files- Holi Vrindavan Tour follows a standard procedure of using
              ...
              Web Beacons Like any other website, Holi Vrindavan Tour uses
              ...
              on the internet. However, visitors may choose to decline the use
              of DART cookies by visiting the Google ad and content network
              Privacy Policy at the following URL –
              https://policies.google.com/technologies/ads. Some of advertisers
              on our site may use cookies and web beacons. Our advertising
              partners are listed below. Each of our advertising partners has
              their own Privacy Policy for their policies on user data. For
              easier access, we hyperlinked to their Privacy Policies below.
              Google https://policies.google.com/technologies/ads Advertising
              Partners Privacy Policies You may consult this list to find the
              Privacy Policy for each of the advertising partners of Holi
              Vrindavan Tour. Third-party ad servers or ad networks uses
              ...
              Holi Vrindavan Tour, which are sent directly to users' browser.
              ...
              content that you see on websites that you visit. Note that Holi
              Vrindavan Tour has no access to or control over these cookies that
              are used by third-party advertisers. Third-Party Privacy Policies
              Holi Vrindavan Tour's Privacy Policy does not apply to other
              ...
              Privacy Policy Links. You can choose to disable cookies through
              your individual browser options. To know more detailed information
              about cookie management with specific web browsers, it can be
              found at the browsers' respective websites. What Are Cookies? CCPA
              Privacy Policy (Do Not Sell My Personal Information) Under the
              ...
              to exercise any of these rights, please contact us. GDPR Privacy
              Policy (Data Protection Rights) We would like to make sure you are
              fully aware of all of your data protection rights. Every user is
              entitled to the following: The right to access – You have the
              right to request copies of your personal data. We may charge you a
              small fee for this service. The right to rectification – You have
              the right to request that we correct any information you believe
              is inaccurate. You also have the right to request that we complete
              the information you believe is incomplete. The right to erasure –
              You have the right to request that we erase your personal data,
              under certain conditions. The right to restrict processing – You
              ...
              these rights, please contact us. Children's Information Another
              part of our priority is adding protection for children while using
              the internet. We encourage parents and guardians to observe,
              participate in, and/or monitor and guide their online activity.
              Holi Vrindavan Tour does not knowingly collect any Personal
