...
const HvtFloatingbtn = () => {
  ...
  return (
    ...
    <div id="pop-up" className={isOpen ? 'visible' : 'hidden'}>
      <a href="tel:+1234567890" target="_blank" className="contact-icon" id="phone-icon">
        <FaPhone />
      </a>
      <a href="https://wa.me/1234567890" target="_blank" className="contact-icon" id="whatsapp-icon">
      <FaWhatsapp />
      </a>
      <a href="mailto:holyvrindavantour@gmail.com" className="contact-icon" id="email-icon">
        <FaEnvelope />
      </a>
    </div>
  </section>
